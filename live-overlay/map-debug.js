(function () {
  ...
  function buildPanel() {
    ...
    panel.innerHTML =
      '<header class="map-debug-head"><h2>Map calibration</h2>' +
      '<p class="map-debug-hint">1) Match <span class="dbg-accent">grid</span> to map · 2) drag map to offset · 3) wheel = scale</p></header>' +
